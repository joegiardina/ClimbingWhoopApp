...
////////////////////////
  return (
    <View
      ...
      {timerState === 'preparing' && <Text style={{marginTop: spacing.large, textAlign: 'center', color: textColor, fontSize: fontSizes.large}}>GET PSYCHED</Text>}
      {timerState === 'working' && <Text style={{marginTop: spacing.large, textAlign: 'center', color: textColor, fontSize: fontSizes.large}}>Get it!!</Text>}
      {timerState === 'resting' && <Text style={{marginTop: spacing.large, textAlign: 'center', color: textColor, fontSize: fontSizes.large}}>Rest</Text>}
      {timerState === 'done' && remainingSets > 0 && <Text style={{marginTop: spacing.large, textAlign: 'center', color: textColor, fontSize: fontSizes.large}}>{remainingSets} {remainingSets === 1 ? 'set' : 'sets'} to go. Keep it up!</Text>}
      {timerState === 'done' && remainingSets === 0 && <Text style={{marginTop: spacing.large, textAlign: 'center', color: textColor, fontSize: fontSizes.large}}>Good job!</Text>}
      <View
        style={{
          flex: 1,
          alignItems: 'center',
